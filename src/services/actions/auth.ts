...
export type TAuthActions =
  ...
  | IAuthResetPasswordStartAction
  | IAuthResetPasswordSuccessAction
  | IAuthResetPasswordErrorAction
  | IAuthForgotPasswordStartAction
  | IAuthForgotPasswordSuccessAction
  | IAuthForgotPasswordErrorAction
  | IAuthGetUserStartAction
  | IAuthGetUserSuccessAction
  | IAuthGetUserErrorAction
  | IAuthPatchUserStartAction
  | IAuthPatchUserSuccessAction
  | IAuthPatchUserErrorAction
  | IAuthClearErrorAction
  | IAuthTokenStartAction
  | IAuthTokenSuccessAction
  | IAuthTokenErrorAction;
...
export const resetPWAction = (data: TResetPassword)=> (dispatch: AppDispatch) => {
