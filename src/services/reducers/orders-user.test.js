...
describe("orders-user reducer", () => {
    ...
    it("should handle ORDERS_USER_ERROR", () => {
      expect( ordersUserReducer(initialState, { type: ORDERS_USER_ERROR, error: errorMessage })).toEqual({
        ...initialState,
        error: errorMessage
      });
    });
    it("should handle ORDERS_USER_MESSAGE", () => {
      expect(
        ordersUserReducer(initialState, { type: ORDERS_USER_MESSAGE, message: message })
      ).toEqual({
        ...initialState,
       error: null,
        message: message,
