...
describe('auth reducer', () => {
    ...
    it("should handle AUTH_REGISTER_SUCCESS", () => {
        expect(authReducer(initialState, { type: AUTH_REGISTER_SUCCESS }))
    ...
    it("should handle AUTH_PATCH_USER_SUCCESS", () => {
        expect(authReducer(initialState, { type: AUTH_PATCH_USER_SUCCESS }))
            .toEqual({ ...initialState, requestStart: false, requestError: null, requestSuccess: true});
    }); 
    ...
    it("should handle AUTH_CLEAR_ERRORS", () => {
        expect(authReducer(initialState, { type: AUTH_CLEAR_ERRORS }))
            .toEqual({ ...initialState, requestStart: false, requestError: null, requestSuccess: false });
    });
});
