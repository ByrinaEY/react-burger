   ...
   return (
      <>
         ...
         <Routes location={background || location}>
            ...
            <Route path="/register" element={<OnlyUnAuth component={<Register />} onlyUnAuth={true} />} />
            <Route path="/login" element={<OnlyUnAuth component={<Login />} onlyUnAuth={true} />} />
            <Route path="/forgot-password" element={<ForgotPassword />} />
            <Route path="/reset-password" element={<ResetPassword />} />
            <Route path="/profile" element={<OnlyAuth component={<Profile />} onlyUnAuth={false} />}>
